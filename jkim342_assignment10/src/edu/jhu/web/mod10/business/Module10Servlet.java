package edu.jhu.web.mod10.business;
...
import edu.jhu.web.mod10.util.MailUtilGmail;

@WebServlet("/Module10Servlet")
public class Module10Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public Module10Servlet() {
