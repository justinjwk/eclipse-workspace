package edu.jhu.web.mod8.business;
...
import edu.jhu.web.mod8.util.MailUtilGmail;

@WebServlet("/Module8Servlet")
public class Module8Servlet extends HttpServlet {
	private static final long serialVersionUID = 1L;

    public Module8Servlet() {
